          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in-left">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed mb-8">
                ...
                believe in using our skills to create meaningful impact. From
                AI-powered solutions to secure web applications, we build
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We're working on exciting projects that will showcase our diverse
              capabilities across AI, security, and social impact.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center group">
                <div className="w-20 h-20 rounded-full overflow-hidden mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 ring-4 ring-primary/20">
                  <img
